<?php
    ...
    if(isset($_POST['update'])){
        ...
        // $update_tglkirim = $_POST['tanggal_pengiriman'];
        mysqli_query($konek, "UPDATE `pesanan` SET status_pembayaran = '$update_pembayaran', status_pemesanan = '$update_status', tanggal_pengiriman = NOW() WHERE id_pesanan = '$id_pesanan'") or die('query failed');
    ...
    if(isset($_POST['HapusOrder'])){
        ...
        // header('location:admin_o_selesai.php');
    }
    // if (isset($_GET['lihat_bukti'])) {
    //     // Cek apakah terdapat foto pembayaran
    //     $id_bayar = $_POST ['id_bayar'];
    //     $hasil_query =  mysqli_query($konek, "SELECT bukti_pembayaran FROM `pesanan` WHERE id_pesanan = 'id_bayar'") or die('query failed');
    //     if (empty($hasil_query)) {
    //         echo "Belum ada bukti pembayaran.";
    //     } else {
    //         $foto_pembayaran = $hasil_query['bukti_pembayaran'];
    //         echo "<img src=\"path_ke_foto/$foto_pembayaran\" alt=\"Bukti Pembayaran\">";
    //     }
    // }
?>
...
<body>
        ...
        <a class="navbar-brand " href="#">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4 mr-lg-5">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="admin_order.php">Orders</a></li>
    ...
    <section class="py-5">
        <div class="col-md-12">
            <img width="100%" src="img/pesan.png">
        </div>
    </section>
    ...
    <section class="" id="produk">
        <div class="container px-4 px-lg-5 mt-1 py-3 border-top">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-2 justify-content-center mt-4">
                ...
                <?php
                    $select_orders = mysqli_query($konek, "SELECT * FROM `pesanan` ORDER BY tanggal_pemesanan desc") or die('query failed');
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                ...
                                <select class="form-select mb-2 mt-2" name="update_payment" aria-label="Default select example">
                                    <option disabled selected><?php echo $fetch_orders['status_pembayaran']; ?></option>
                                    <option value="COD">COD</option>
                                    <option value="belum bayar">belum bayar</option>
                                    <option value="selesai bayar">selesai bayar</option>
                                </select>
                                <strong>Status Pesanan</strong> : <br>
                                <select class="form-select mb-2 mt-2" name="update_status" aria-label="Default select example">
                                    <option disabled selected><?php echo $fetch_orders['status_pemesanan']; ?></option>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Pesanan (ID = <?php echo $fetch_orders['id_order'] ?> )</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <form method="POST" action="">
                                                    <div class="modal-body">
                                                        <input type="hidden" name="delete_id" value="<?php echo $fetch_orders['id_order']; ?>">
                                                        <div class="mb-2">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-2">
                                                        <p>
                                                            <strong>ID User</strong> : <span><?php echo $fetch_orders['id_user']; ?></span> <br>
                                                            <strong>Nama</strong> : <span><?php echo $fetch_orders['username']; ?></span> <br> 
                                                            ...
                                                            <!-- <strong>Total Diskon</strong> : <span><?php echo $fetch_orders['total_diskon']; ?></span> <br>  -->
                                                            ...
                                                            <strong>Status Pemesanan</strong> : <span><?php echo $fetch_orders['status_pemesanan']; ?></span> <br>
                                                            ...
                                                            <strong>Bukti Pembayaran</strong> :  <span><?php echo $fetch_orders['bukti_pembayaran']; ?></span><br> 
                ...
                ?>
                    <div class="card col-md-10 offset-md-1 p-5 text-center mb-5 mt-4">Belum ada pesanan yang dibuat<div>
                <?php
                    }
                ?>
