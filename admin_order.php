<?php
    ...
    if(isset($_POST['update'])){
        ...
        $tanggal_sekarang = gmdate("Y-m-d H:i:s");
        mysqli_query($konek, "UPDATE `pesanan` SET status_pembayaran = '$update_pembayaran', status_pemesanan = '$update_status', tanggal_pengiriman = '$tanggal_sekarang' WHERE id_pesanan = '$order_id'") or die('query failed');
...
<body>
    ...
    <section class="py-5">
        <div class="col-md-12">
            <img width="100%" src="img/diproses.png">
        </div>
    </section>
    ...
    <section id="addproduct">
        <div class="container">
            <div class="row justify-content-center">
                <a href="admin_o_proses.php" class="btnload btn btn-primary col-md-2 mb-3 m-2">Sedang Diproses</a>
                <a href="admin_o_pengiriman.php" class="active1 btn btn-primary col-md-2 mb-3 m-2">Dalam Pengiriman</a>
                <a href="admin_o_selesai.php" class="active1 btn btn-primary col-md-2 mb-3 m-2">Selesai</a>
            </div>
        </div>
    </section>
    ...
    <section class="" id="produk">
        <div class="container px-4 px-lg-5 mt-1 py-3 border-top">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-2 justify-content-center mt-4">
                ...
                <?php
                    $select_orders = mysqli_query($konek, "SELECT * FROM `pesanan` WHERE status_pemesanan = 'Diproses' ORDER BY tanggal_pemesanan desc") or die('query failed');
                ...
                <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                ...
                                <select class="form-select mb-2 mt-2" name="update_pembayaran" aria-label="Default select example">
