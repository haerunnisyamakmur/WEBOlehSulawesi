...
<body>
    ...
    <div class="container mt-5 mb-5 text-center">
        <h1 class="row col-md-12 mt-5" style="color:white;">EDIT CABANG</h1>
    </div>
    <div class="container">
        <?php
            $update_id = $_GET['update'];
            $select_products = mysqli_query($konek, "SELECT * FROM `cabang` WHERE id_cabang = '$update_id'") or die('query failed');
            ...
            <div class="row mt-5 mb-5">
                <div class="col-md-5 mt-4">
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" value="<?php echo $fetch_products['nama_cabang']; ?>" name="NamaCabang">
                    </div>
                    <div class="mb-2">
                        <label for="exampleFormControlInput1" class="form-label">Jam Buka</label>
                        <input type="text" class="form-control" value="<?php echo $fetch_products['jam_buka']; ?>" name="JamBuka">
                    </div>
                    <div class="mb-2">
                        <label for="exampleFormControlInput1" class="form-label">Alamat Cabang</label>
                        <textarea type="text" class="form-control" <?php echo $fetch_products['alamat_cabang']; ?> name="AlamatCabang"><?php echo $fetch_products['alamat_cabang']; ?></textarea>
                    </div>
                    <div class="mb-2">
                            <label for="exampleFormControlInput1" class="form-label">Lokasi</label>
                            <input type="text" class="form-control" value="<?php echo $fetch_products['link_cabang']; ?>" name="LinkCabang">
                        </div>
                    <div class="mb-2">
                        <label for="formFile" class="form-label">Gambar Produk</label>
                        <input class="form-control" type="file" accept="image/jpg, image/jpeg, image/png" name="image">
                    </div>
                    <input type="hidden" value="<?php echo $fetch_products['id_cabang']; ?>" name="update_p_id">
                    <input type="hidden" value="<?php echo $fetch_products['gambar_cabang']; ?>" name="update_p_image">
                    <hr class="my-4">
                    <a href="admin_cabang.php" class="btn btn-hapus btn-primary col-4 btn-md">KEMBALI</a>
                    <button type="submit" class="btn btn-primary btnload col-4" name="edit">EDIT</button>
                </div>
                <div class="col-md-7 mt-4">
                    <img class = "image" src="img/<?php echo $fetch_products['gambar_cabang']; ?>" alt="" sizes="50%" class="col-md-12">
                </div>
