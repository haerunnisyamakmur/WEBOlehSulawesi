...
<body>
    ...
    <section class="py-5">
        <div class="col-md-12">
            <img width="100%" src="img/dikirim.png">
        </div>
    </section>
    ...
    <section id="addproduct">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <a href="admin_o_pengiriman.php" class="btn btn-primary btnload col-md-2 mb-3 m-2">Dalam Pengiriman</a>
    ...
    <section class="" id="produk">
        <div class="container px-4 px-lg-5 mt-1 py-3 border-top">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-2 justify-content-center mt-4">
                ...
                <?php
                    $select_orders = mysqli_query($konek, "SELECT * FROM `pesanan` WHERE status_pemesanan = 'Dikirim' ORDER BY tanggal_pemesanan desc") or die('query failed');
