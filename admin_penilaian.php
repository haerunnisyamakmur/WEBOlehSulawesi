<?php
    ...
    if(isset($_POST['HapusPesan'])){
        ...
        mysqli_query($konek, "DELETE FROM `penilaian` WHERE id_penilaian = '$delete_id'") or die('query failed');
...
<body>
        ...
        <a class="navbar-brand " href="#">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4 mr-lg-5">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="admin_penilaian.php">Penilaian</a></li>
                </ul>
                <div class="d-flex">
    ...
    <section class="py-5">
        <div class="col-md-12">
            <img width="100%" src="img/penilaian.png">
        </div>
    </section>
    ...
    <section class="">
        <div class="container px-4 px-lg-5 mt-1 py-3 border-top">
            ...
            <?php
            $select_pesan = mysqli_query($konek, "SELECT * FROM `penilaian` ORDER BY id_penilaian DESC") or die('query failed');
            ...
            ?>
                ...
                <div class="col mb-5" action="" method="post">
                    <div class="card h-100">
                        <div class="card-body p-4 pb-4">
                            <p>
                                <strong>ID Pesanan</strong>: <?php echo $fetch_pesan['id_pesanan'] ?> <br>
                                <strong>Tanggal</strong>: <?php echo $fetch_pesan['tanggal'] ?> <br>
                                <strong>Nama </strong>: <?php echo $fetch_pesan['username'] ?> <br>
                                <strong>Rating </strong>: <?php echo $fetch_pesan['rating'] ?>/5 <br>
                                <strong>Ulasan </strong>: <?php echo $fetch_pesan['penilaian'] ?> <br>
                                
                            </p>
                        </div>
                        <!-- Product actions-->
                        <form class="card-footer p-4 pt-0 border-top-0 bg-transparent" action="" method="POST">
                            <input type="hidden" name="id_penilaian" value="<?php echo $fetch_pesan['id_penilaian']; ?>">
                        
                            <!-- <button class="btn btn22 btn-outline-secondary mt-2 col-12" name="delete">Delete</button> -->

                            <!-- <a href="admin_message.php?delete=<?php echo $fetch_pesan['id_penilaian']; ?>" onclick="return confirm('delete this message?');" class="btn btn22 btn-outline-secondary mt-2 col-12">delete</a> -->
                            <a href="#" class="btn btn23 btn-outline-secondary mt-2 col-12" data-bs-toggle="modal" data-bs-target="#hapusPesan<?= $fetch_pesan['id_penilaian'] ?>">Hapus</a>

                            <div class="modal fade" id="hapusPesan<?= $fetch_pesan['id_penilaian'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="">
                                            <div class="modal-body">
                                                <input type="hidden" name="delete_id" value="<?php echo $fetch_pesan['id_penilaian']; ?>">
                                                <div class="mb-2">
                ...
                ?>
                    <div class="card p-5 text-center mb-5 mt-4">Tidak ada penilaian<div>
                <?php
                    }
                ?>
