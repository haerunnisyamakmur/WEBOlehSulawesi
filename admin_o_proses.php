<?php
    ...
    if(isset($_POST['update'])){
        ...
        mysqli_query($konek, "UPDATE `pesanan` SET status_pemesanan = '$update_status', tanggal_pengiriman = NOW() WHERE id_pesanan = '$order_id'") or die('query failed');
    ...
    <section class="" id="produk">
        <div class="container px-4 px-lg-5 mt-1 py-3 border-top">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-2 justify-content-center mt-4">
                ...
                <?php
                    $select_orders = mysqli_query($konek, "SELECT * FROM `pesanan` WHERE status_pemesanan = 'Diproses' ORDER BY id_pesanan desc") or die('query failed');
                ...
                <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                ...
                                <strong>Bukti Pembayaran</strong> : <a class = "link" href="#" data-bs-toggle="modal" data-bs-target="#lihatBukti<?= $fetch_orders['id_pesanan'] ?>"> Lihat </a> <br>
